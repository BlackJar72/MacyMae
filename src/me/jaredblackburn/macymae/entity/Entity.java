...
public class Entity implements IMsgSender, IMsgReciever {
    ...
    public static void init() {
        macy    = entities[4] = new Entity(19, 8, 0f, 0f, 0f, 100000l, true, 
                            false, new InputControl(), "macy");
        whisp1  = entities[0] = new Entity(17, 16, 0f, 0f, 0f, 100000l, true, 
                            false, new InputControl(), "wisp1");
        whisp2  = entities[1] = new Entity(21, 16, 0f, 0f, 0f, 100000l, true, 
                            false, new InputControl(), "wisp2");
        whisp3  = entities[2] = new Entity(17, 18, 0f, 0f, 0f, 100000l, true, 
                            false, new InputControl(), "wisp3");
        whisp4  = entities[3] = new Entity(21, 18, 0f, 0f, 0f, 100000l, true, 
    ...
    public Entity(int sx, int sy, float z, float speed, 
            float BASE_SPEED, long MSPF, boolean isPlayer, 
